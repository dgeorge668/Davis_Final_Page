$(document).ready(function() {
	...
	$('#creditz').hover(function() {
		$('.med').text("Credit Analysis: Written in R. Modeled risk of loan default using Bayesian Model Averaging on dataset of >100,000 loan samples. Click to view the full report.");
	});
